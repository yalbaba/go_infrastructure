...
func MainHandlerName(handlers Handlers) (name string) {
	for i := 0; i < len(handlers); i++ {
		...
		if !strings.HasPrefix(name, "github.com/yalbaba/go_infrastructure/pkg/iris") ||
			strings.HasPrefix(name, "github.com/yalbaba/go_infrastructure/pkg/iris/core/router.StripPrefix") ||
			strings.HasPrefix(name, "github.com/yalbaba/go_infrastructure/pkg/iris/core/router.FileServer") {
			break
		}
	}
